...
class TOtherGameController:
    def __init__(self,view):
        ...
        self.view.set_buttons({"Start":self.game_phase,
                               "Higher":lambda: self.view.update_card_screen(self.model.get_next_card("H"),self.restart_callback),
                               "Lower":lambda: self.view.update_card_screen(self.model.get_next_card("L"),self.restart_callback),})
        self.start_phase()
